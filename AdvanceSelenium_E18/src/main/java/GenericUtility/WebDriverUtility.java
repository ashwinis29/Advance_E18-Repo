...
public class WebDriverUtility {
	...
	public void waitForURLContains(WebDriver driver, String fraction, long sec)
	{
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(sec));
		wait.until(ExpectedConditions.urlContains(fraction));
	}
	
	public void waitForElementLocatedByLocator(WebDriver driver, By locator, long sec)
	{
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(sec));
